...
class TestTimelapseIntegration(unittest.TestCase):
    def setUp(self):
        ...
        self.image_dir = os.path.join(self.config.global_config.work_dir, "images")
    ...
    def test_create_timelapse_pi_wide(self, mock_is_pi):
        ...
        self.assertTrue(create_timelapse(self.image_dir, overwrite=True, two_pass=False, tmp_dir=self.config.global_config.work_dir))
    ...
    def test_create_timelapse_pi_tall(self, mock_is_pi):
        ...
        cameras_json_path = os.path.join(self.config.global_config.work_dir, "cameras.json")
